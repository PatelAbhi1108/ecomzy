...
import { add, remove } from "../redux/Slices/CartSlice"; // Corrected import, removed unused 'ass'
import { toast } from "react-hot-toast";

const Product = ({ post }) => {
  const cart = useSelector((state) => state.cart); // Directly get cart from state
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[0_3px_10px_rgb(0,0,0,0.2)] hover: ease-in">
      <div>
